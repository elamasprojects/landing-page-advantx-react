  ...
  const steps = [
    {
      ...
      icon: Search,
      color: "from-blue-500 to-primary-600 dark:from-blue-400 dark:to-primary-500"
    },
    {
      number: "02", 
      ...
      icon: Cog,
      color: "from-primary-600 to-purple-600 dark:from-primary-500 dark:to-purple-500"
    },
    {
      number: "03",
      title: "Escalado",
    ...
    <section className="py-20 bg-white dark:bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Connection Line */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-0.5 bg-gradient-to-r from-blue-200 via-primary-200 to-purple-200 dark:from-blue-500/30 dark:via-primary-500/30 dark:to-purple-500/30 hidden lg:block"></div>
          
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16">
            {steps.map((step, index) => (
              <div key={index} className="relative">
                {/* Step Card */}
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg hover:shadow-xl dark:shadow-xl dark:hover:shadow-2xl transition-shadow border border-gray-100 dark:border-slate-700 relative z-10">
                  {/* Step Number */}
                ...
                {index < steps.length - 1 && (
                  <div className="flex justify-center my-8 lg:hidden">
                    <div className="w-0.5 h-16 bg-gradient-to-b from-primary-300 to-purple-300 dark:from-primary-500/50 dark:to-purple-500/50"></div>
                  </div>
                )}
              </div>
            ))}
