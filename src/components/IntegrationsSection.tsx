  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div
          className="relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-2xl border bg-background p-10 md:shadow-xl"
          ref={containerRef}
        >
