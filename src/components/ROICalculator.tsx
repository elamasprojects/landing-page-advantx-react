...
const ROICalculator = () => {
  ...
  const calculateROI = () => {
    ...
    const monthlySavings = dailySavings * 22; // días laborables
    const annualSavings = monthlySavings * 12;
    const implementationCost = 15000; // Costo promedio de implementación
    ...
    const paybackMonths = Math.ceil(implementationCost / (monthlySavings - monthlyMaintenance));
